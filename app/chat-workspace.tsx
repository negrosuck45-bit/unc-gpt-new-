...
export default function Home({ accountScope }: { accountScope: string }) {
  ...
  return (
    ...
    >
      {showStartupGlow && (
        <div className="fixed inset-0 z-[700] h-dvh w-screen bg-black" role="status" aria-label="Opening Stram">
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-44 w-44 -translate-x-1/2 -translate-y-1/2">
            ...
            <Image src="/stram-mark.svg" alt="Stram" width={128} height={128} priority className="absolute left-1/2 top-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 object-contain drop-shadow-[0_0_12px_rgba(255,255,255,0.95)] drop-shadow-[0_0_42px_rgba(187,211,255,0.75)]" />
          </div>
        </div>
      )}
