  ...
  return (
    <main className="document-scroll-page min-h-screen bg-[#070709] px-6 py-16 text-white">
      <article className="mx-auto max-w-2xl rounded-3xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur-xl sm:p-12">
        ...
        <p className="mt-6 leading-7 text-white/65">Authentication is handled by Clerk. Passwords and identity-provider credentials are entered directly into Clerk’s secure flow rather than stored by this interface.</p>
