...
- [ ] Verify desktop and mobile layouts, voice behavior, linting, type checks, and production build
- [ ] Commit verified changes to main so the linked Vercel project auto-deploys
- [ ] Confirm the Vercel deployment status and report the deployed release
- [ ] Fix inherited FIZ CSS-module purity and error-route prerender blockers so the production build completes
